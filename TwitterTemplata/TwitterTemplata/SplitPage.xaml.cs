...
namespace TwitterTemplata
{
    ...
    public sealed partial class SplitPage : TwitterTemplata.Common.LayoutAwarePage
    {
        public SplitPage()
        {
        ...
        protected async override void LoadState(Object navigationParameter, Dictionary<String, Object> pageState)
        {
            ...
            List<itemTwitter> list = new List<itemTwitter>();

            SyndicationClient client = new SyndicationClient();
            SyndicationFeed feed = await client.RetrieveFeedAsync(new Uri("https://api.twitter.com/1/statuses/user_timeline.rss?screen_name=RandomFactsPL"));

            foreach (var item in feed.Items)
            {
                list.Add(new itemTwitter
                {
                    Tweet = item.Title.Text.Replace("RandomFactsPL:",""),
                    Link = item.Id,
                    Date = item.PublishedDate.ToLocalTime().ToString()
                });
            }

            this.itemsViewSource.Source = list;
